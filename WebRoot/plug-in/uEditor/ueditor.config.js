...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       // ,videoPath:URL + "jsp/"                   //附件修正地址，同imagePath
        ...
        , toolbars:[
            [   'fontfamily', 'fontsize', 'paragraph', 'indent','bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist',  '|',
                'rowspacingtop', 'rowspacingbottom', 'lineheight',   '|', 
                'link', 'unlink', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
                'insertimage','map', 'pagebreak','horizontal', 'spechars','|',
                'removeformat', 'formatmatch', 'autotypeset', 'pasteplain','|','undo', 'redo', '|','selectall', 'cleardoc','|','source','preview','fullscreen']
        ]
